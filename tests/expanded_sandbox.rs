...
impl<'de> serialization::Decode<'de> for Log {
    fn decode<_D: serialization::Decoder<'de>>(
        decoder: _D,
        place: &mut std::mem::MaybeUninit<Self>,
    ) -> Result<(), _D::Error> {
        {
            if const { serialization::binary_format::is_not_fast_binary::<Log, _D>() } {
                let mut struc = decoder.decode_struct()?;
                let value_place: &mut std::mem::MaybeUninit<Address> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().address) };
                serialization::CompositeDecoder::decode_element::<Address>(
                    &mut struc,
                    value_place,
                )?;
                let value_place: &mut std::mem::MaybeUninit<String> = unsafe {
                    serialization::const_transmute(&mut place.assume_init_mut().identity)
                };
                serialization::CompositeDecoder::decode_element::<String>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<String> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().userid) };
                serialization::CompositeDecoder::decode_element::<String>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<String> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().date) };
                serialization::CompositeDecoder::decode_element::<String>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<String> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().request) };
                serialization::CompositeDecoder::decode_element::<String>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<u16> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().code) };
                serialization::CompositeDecoder::decode_element::<u16>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<u64> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().size) };
                serialization::CompositeDecoder::decode_element::<u64>(&mut struc, value_place)?;
...
impl<'de> serialization::binary_format::DecodeField<'de> for Log {
    unsafe fn decode_field<_D: serialization::CompositeDecoder<'de>>(
        ...
        match fields.pop_last() {
            0_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.address,
                decoder,
            ),
            1_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.identity,
                decoder,
            ),
            2_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.userid,
                decoder,
            ),
            3_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.date,
                decoder,
            ),
            4_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.request,
                decoder,
            ),
            5_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.code,
                decoder,
            ),
            6_u16 => serialization::binary_format::DecodeField::decode_field(
                fields,
                &mut field.size,
                decoder,
            ),
    ...
    fn decode<_D: serialization::Decoder<'de>>(
    ...
    ) -> Result<(), _D::Error> {
        {
            if const { serialization::binary_format::is_not_fast_binary::<Logs, _D>() } {
                let mut struc = decoder.decode_struct()?;
                let value_place: &mut std::mem::MaybeUninit<Vec<Log>> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().logs) };
                serialization::CompositeDecoder::decode_element::<Vec<Log>>(
                    &mut struc,
                    value_place,
                )?;
                serialization::CompositeDecoder::end(struc)?;
    ...
    fn decode<_D: serialization::Decoder<'de>>(
    ...
    ) -> Result<(), _D::Error> {
        {
            if const { serialization::binary_format::is_not_fast_binary::<Address, _D>() } {
                let mut struc = decoder.decode_struct()?;
                let value_place: &mut std::mem::MaybeUninit<u8> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().x0) };
                serialization::CompositeDecoder::decode_element::<u8>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<u8> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().x1) };
                serialization::CompositeDecoder::decode_element::<u8>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<u8> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().x2) };
                serialization::CompositeDecoder::decode_element::<u8>(&mut struc, value_place)?;
                let value_place: &mut std::mem::MaybeUninit<u8> =
                    unsafe { serialization::const_transmute(&mut place.assume_init_mut().x3) };
                serialization::CompositeDecoder::decode_element::<u8>(&mut struc, value_place)?;
                serialization::CompositeDecoder::end(struc)?;
                Ok(())
            } else {
