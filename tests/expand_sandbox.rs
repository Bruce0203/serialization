...
const _: () = {
        ...
        Self: ::serialization::__private::CompoundUnwrapper<__C, __S>,
    {
        type Compound = <A14<
            T,
        > as ::serialization::__private::CompoundUnwrapper<__C, __S>>::Output;
    }
    impl<T> ::serialization::Encode for A14<T> {
        fn encode<E: ::serialization::Encoder>(
            &self,
            _encoder: &mut E,
        ) -> Result<(), E::Error> {
            Ok(())
    ...
    impl<C, S, T, const I: usize> ::serialization::__private::Edge<C>
    for __FieldToken<S, T, I>
    where
    ...
    {
        type Compound = <T as ::serialization::__private::CompoundWrapper<
            C,
            S,
        >>::Compound;
    }
    ...
    impl<S, T, const I: usize> ::serialization::__private::Vector
    for __FieldToken<S, T, I>
    where
    ...
    const _: () = {
        ...
        where
            [(); __field_offset::<T>()]:,
        {
            type Offset = ::serialization::__private::typenum::Const<
                { __field_offset::<T>() },
            >;
        }
...
const _: () = {
    impl<T, T2> ::serialization::__private::EnumDiscriminantDecoder<A16<T, T2>>
    for A16<T, T2> {
        fn decode_enum_discriminant(
            variant_index: &::serialization::EnumVariantIndex,
            out: &mut core::mem::MaybeUninit<A16<T, T2>>,
        ) {
            match variant_index.0 {
                0usize => {
                    __VariantToken2::<
                        0usize,
                    >::decode_enum_discriminant(variant_index, out);
                }
                1usize => {
                    __VariantToken2::<
                        1usize,
    ...
    impl<T, T2> core::convert::Into<::serialization::EnumVariantStringId>
    for &A16<T, T2> {
        fn into(self) -> ::serialization::EnumVariantStringId {
            use A16::*;
            match self {
                A(..) => ::serialization::EnumVariantStringId("A"),
                B(..) => ::serialization::EnumVariantStringId("B"),
                _ => unsafe { core::hint::unreachable_unchecked() }
            }
        }
    }
    impl<
        T,
        T2,
    > core::convert::Into<::serialization::EnumVariantDiscriminantId<A16<T, T2>>>
    for &A16<T, T2>
    where
        [(); core::mem::size_of::<core::mem::Discriminant<A16<T, T2>>>()]:,
    {
        fn into(self) -> ::serialization::EnumVariantDiscriminantId<A16<T, T2>> {
            ::serialization::EnumVariantDiscriminantId::new(self)
        }
    }
    ...
    impl<
        T,
        T2,
    > ::serialization::EnumIdentifierToVariantIndex<::serialization::EnumVariantStringId>
    for A16<T, T2>
    where
        [(); core::mem::size_of::<core::mem::Discriminant<Self>>()]:,
    {
        fn enum_variant_index_by_identifier(
            id: ::serialization::EnumVariantStringId,
        ) -> Result<
            ::serialization::EnumVariantIndex,
            ::serialization::EnumIdentifierToVariantIndexError,
        > {
            match id.0 {
                "A" => Ok(::serialization::EnumVariantIndex(0usize)),
                "B" => Ok(::serialization::EnumVariantIndex(1usize)),
                _ => {
                    Err(
                        ::serialization::EnumIdentifierToVariantIndexError::InvalidIdentifier,
                    )
                }
            }
        }
    ...
    impl<
        T,
        T2,
    > ::serialization::EnumIdentifierToVariantIndex<
        ::serialization::EnumVariantDiscriminantId<A16<T, T2>>,
    > for A16<T, T2>
    where
        [(); core::mem::size_of::<core::mem::Discriminant<Self>>()]:,
    {
        fn enum_variant_index_by_identifier(
            id: ::serialization::EnumVariantDiscriminantId<A16<T, T2>>,
        ) -> Result<
            ::serialization::EnumVariantIndex,
            ::serialization::EnumIdentifierToVariantIndexError,
        > {
        ...
        T2: ::serialization::__private::Edge<__C>,
    {
        ...
        > as core::ops::Add<
            ::serialization::__private::Variant<
                __VariantToken<T, T2, { (0) + 1 }>,
                { (0) + 1 },
            >,
        >>::Output as core::ops::Add<
    ...
    impl<T, T2, const I: usize> ::serialization::__private::Len
    for __VariantToken<T, T2, I> {
        const SIZE: usize = <A16<T, T2> as ::serialization::__private::Len>::SIZE;
    }
    impl<T, T2, const I: usize> ::serialization::__private::Size
    for __VariantToken<T, T2, I> {
    ...
    impl<T, T2, __C, __S> ::serialization::__private::CompoundWrapper<__C, __S>
    for A16<T, T2>
    where
        Self: ::serialization::__private::CompoundUnwrapper<__C, __S>,
    {
    ...
    impl<T, T2> ::serialization::__private::EnumDiscriminantDecoder<A16<T, T2>>
    for __VariantToken2<0usize> {
        fn decode_enum_discriminant(
            variant_index: &::serialization::EnumVariantIndex,
            out: &mut core::mem::MaybeUninit<A16<T, T2>>,
        ) {
            unsafe {
                let v0 = core::mem::MaybeUninit::uninit().assume_init();
                *out.assume_init_mut() = A16::A(v0);
            }
        }
    }
    impl<T, T2, __C> ::serialization::__private::Edge<__C>
    for __VariantToken<T, T2, 0usize>
    where
        T: ::serialization::__private::Edge<__C>,
        T2: ::serialization::__private::Edge<__C>,
    {
        ...
        type Second = ::serialization::__private::PhantomEdge<
            ...
            (
                ::serialization::__private::Padding<
                    __C,
                    Self,
                    ::serialization::__private::FrontOffsetToken,
                >,
                <<::serialization::__private::End<
                    __C,
    ...
    for __VariantToken2<1usize> {
        fn decode_enum_discriminant(
            ...
            unsafe {
                let v0 = core::mem::MaybeUninit::uninit().assume_init();
                *out.assume_init_mut() = A16::B(v0);
            }
        }
    }
    impl<T, T2, __C> ::serialization::__private::Edge<__C>
    for __VariantToken<T, T2, 1usize>
    where
        T: ::serialization::__private::Edge<__C>,
        T2: ::serialization::__private::Edge<__C>,
    {
...
#[automatically_derived]
impl<T: ::core::cmp::PartialEq, T2: ::core::cmp::PartialEq> ::core::cmp::PartialEq
for A16<T, T2> {
    #[inline]
...
const _: () = {
        ...
        'a: 'static,
    {
        ...
        > as core::ops::Add<
            ::serialization::__private::Padding<
                ...
                A17<'a>,
                ::serialization::__private::Field<
                    __FieldToken<A17<'a>, PhantomData<&'a ()>, 0>,
                >,
            >,
        >>::Output as core::ops::Add<
            ::serialization::__private::Field<
    ...
    const _: () = {
        impl<'a> ::serialization::__private::FieldOffset
        for __FieldToken<A17<'a>, PhantomData<&'a ()>, 0>
        where
            'a: 'static,
            [(); __field_offset::<'a>()]:,
        {
...
const _: () = {
    ...
    impl<T1, T2, __C, __S> ::serialization::__private::CompoundWrapper<__C, __S>
    for AAA<T1, T2>
    where
        Self: ::serialization::__private::CompoundUnwrapper<__C, __S>,
    {
    ...
    const _: () = {
        impl<T1, T2> ::serialization::__private::FieldOffset
        for __FieldToken<AAA<T1, T2>, T1, 0>
        where
    ...
    const _: () = {
        impl<T1, T2> ::serialization::__private::FieldOffset
        for __FieldToken<AAA<T1, T2>, T2, { (0) + 1 }>
        where
            [(); __field_offset::<T1, T2>()]:,
        {
            type Offset = ::serialization::__private::typenum::Const<
