...
// use serialization::{binary_format::SerialDescriptor, Encode};
...
//     bencher.bench_local(|| {
//         type C = &'static mut PacketEncoder<Buffer<100>>;
//         {
//             serialization::binary_format::sized_field_of::<Bar>()
//         }
//     });
// }
// 
...
//             {
//                 #[allow(invalid_value)]
//                 let value: Bar = unsafe { std::mem::MaybeUninit::uninit().assume_init() };
//                 let mut padding_calc =
//                     serialization::binary_format::SizeCalcState::<Bar>::new(&value);
//                 serialization::binary_format::SizeCalcState::next_field::<u8, C>(
//                     &mut padding_calc,
//                     &value.field1,
//                 );
...
//             },
//             serialization::binary_format::sized_field_of::<Self>(),
//         )
//     }
// }
